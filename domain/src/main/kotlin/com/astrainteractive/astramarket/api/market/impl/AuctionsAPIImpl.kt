package com.astrainteractive.astramarket.api.market.impl
...
internal class AuctionsAPIImpl(
    ...
    override suspend fun insertAuction(auctionDTO: AuctionDTO): Int? = runCatchingWithContext(limitedIoDispatcher) {
    ...
    override suspend fun expireAuction(auctionDTO: AuctionDTO) = runCatchingWithContext(limitedIoDispatcher) {
