...
dependencies {
    ...
    shadow(projects.modules.apiMarket)
    shadow(projects.modules.commandBukkit)
    shadow(projects.modules.core)
    shadow(projects.modules.coreBukkit)
    shadow(projects.modules.gui.api)
    shadow(projects.modules.gui.bukkit)
